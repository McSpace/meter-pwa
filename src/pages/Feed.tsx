...
export default function Feed() {
  ...
  if (!selectedProfile) {
    return (
      <>
        <header className="sticky top-0 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm z-10 px-4 pb-4" style={{ paddingTop: 'max(3rem, env(safe-area-inset-top))' }}>
          <ProfileSwitcher />
        </header>
